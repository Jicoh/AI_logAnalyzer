...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'src.ai_analyzer.orchestrator_agent',
        'src.ai_analyzer.skill_loader',
        'src.ai_analyzer.mcp_client',
        'src.ai_analyzer.subagents',
        'src.ai_analyzer.subagents.base',
        'src.ai_analyzer.subagents.registry',
        'src.ai_analyzer.subagents.log_analyzer',
        'src.log_metadata',
    ...
    excludes=[
        ...
        'email.mime',
        'html.parser',
        # xml.dom 和 xml.etree 是 pypdf 的依赖，不能排除
        # 'xml.dom',
        # 'xml.etree',
        'pytz',
        'pyarrow',
